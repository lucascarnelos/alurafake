...
public class CreateSingleChoiceTaskUseCaseImpl implements CreateSingleChoiceTaskUseCase {
    ...
    public CreateSingleChoiceTaskUseCaseImpl(TaskPersistenceGateway taskPersistenceGateway, CoursePersistenceGateway coursePersistenceGateway, GenericTaskValidateUseCase genericTaskValidateUseCase, OrderingTasksUseCase orderingTasksUseCase, TaskWithChoiceValidateUseCase taskWithChoiceValidateUseCase) {
